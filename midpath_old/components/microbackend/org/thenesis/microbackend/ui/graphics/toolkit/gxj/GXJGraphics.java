 ...
 * available.
 * Applications may also use {@link GXJGraphics#getDisplayColor(int)
 ...
 * {@link Canvas#paint(GXJGraphics) paint()}
 ...
 * such as {@link GXJGraphics#translate(int, int) translate()},
 * do not modify the clip.
 * The methods
 * {@link GXJGraphics#getClipX() getClipX()},
 * {@link GXJGraphics#getClipY() getClipY()},
 * {@link GXJGraphics#getClipWidth() getClipWidth()} and
 * {@link GXJGraphics#getClipHeight() getClipHeight()}
 ...
 * {@link GXJGraphics#setClip(int, int, int, int) setClip()}.
 ...
 * in the {@link GXJFont#stringWidth(java.lang.String) stringWidth()}
 * and {@link GXJFont#getHeight() getHeight()}
 * calls of class {@link GXJFont Font}.
...
public class GXJGraphics implements VirtualGraphics {
     ...
     */
    public synchronized VirtualFont getFont() {
        return (VirtualFont)currentFont;
    }
     ...
     */
    public synchronized void setFont(VirtualFont font) {
        currentFont = (font == null) ? GXJFont.getDefaultFont() : (GXJFont)font;
    }
    ...
    public void drawString(java.lang.String str, int x, int y, int anchor) {
        ...
        drawChars(chars, 0, chars.length, x, y, anchor);
    }
    ...
    public void drawSubstring(String str, int offset, int len, int x, int y, int anchor) {
        char[] chars = str.toCharArray();
        drawChars(chars, offset, chars.length, x, y, anchor);
    }
    ...
    public void drawChar(char character, int x, int y, int anchor) {
        ...
        drawChars(chars, 0, 1, x, y, anchor);
    }
     ...
     * @see Image
     */
    public void drawImage(VirtualImage image, int x, int y, int anchor) {
        if (image == null) {
            throw new NullPointerException();
        }

        if (!render((GXJImage)image, x, y, anchor)) {
    ...
    public void drawRegion(VirtualImage src, 
        ...
        if (!renderRegion((GXJImage)src, x_src, y_src, width, height,
     ...
     */
    static GXJGraphics getImageGraphics(GXJImage img) {
        if (null == img) {
            throw new NullPointerException();
        }

        GXJGraphics g = new GXJGraphics();
        g.img = img;
     ...
     *                  the Image is non-null.
     */
    static GXJGraphics getImageGraphics(GXJImage img, int width, int height) {
        if (null == img) {
            throw new NullPointerException();
        }
     ...
     * @return Graphics 
     */
    static GXJGraphics getScreenGraphics(int displayId, int width, int height) {
     ...
     */
    public void resetGC() {
        currentFont = GXJFont.getDefaultFont();
        style       = SOLID;
        rgbColor    = gray = 0;
        pixel       = getPixel(rgbColor, gray, true);
    }
     ...
     * @see Image
     */
    native boolean render(GXJImage img, int x, int y, int anchor);
     ...
     * @see Image
     */
    native boolean renderRegion(GXJImage img,
                                int x_src, int y_src,
                                int width, int height,
                                int transform,
                                int x_dest, int y_dest,
...
//    /* Command queue */
//    
//    private static final int CMD_DRAW_LINE = 1; 
//    private static final int CMD_DRAW_RECT = 2; 
//    private static final int CMD_FILL_RECT = 3;
//    private static final int CMD_DRAW_ROUND_RECT = 4;
//    private static final int CMD_DRAW_ARC = 5; 
//    private static final int CMD_FILL_ARC = 6; 
//    private static final int CMD_DRAW_STRING = 7;
//    private static final int CMD_DRAW_SUBSTRING = 8;
//    private static final int CMD_DRAW_CHAR = 9;
//    private static final int CMD_DRAW_CHARS = 10;
//    private static final int CMD_FILL_TRIANGLE = 11;
//    private static final int CMD_DO_COPY_AREA = 12;
//    private static final int CMD_DRAW_RGB = 13;
//    private static final int CMD_GET_DISPLAY_COLOR = 14;
//    private static final int CMD_RENDER = 15;
//    private static final int CMD_RENDER_REGION = 16;
//    private static final int CMD_GET_PIXEL = 17;
//
//    
//    private static final boolean debugQueue = true;
//    private static final boolean flushQueueAfterEachCommand = true;
//    private static final int COMMAND_QUEUE_SIZE = 4096;
//    private int[] queue = new int[COMMAND_QUEUE_SIZE];
//    private Object[] objectQueue = new Object[COMMAND_QUEUE_SIZE];
//    private int index = 0;
...
//        }
//        _execute(queue, objectQueue, index);
//        index = 0;
//
...
//    }
//
//    private void addToQueue(int cmd, int count) {
