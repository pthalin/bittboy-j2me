 ...
 */
jint gx_get_pixel(jint rgb, int gray, int isGray);
 ...
 */
void gx_draw_line(jint pixel, const jshort *clip,
 ...
 */
void gx_draw_rect(jint pixel, const jshort *clip,
	        	 const gxj_screen_buffer *dst,
 ...
 */
void gx_fill_rect(jint pixel, const jshort *clip,
			 const gxj_screen_buffer *dst,
                         int dotted, int x, int y, int width, int height);
 ...
 */
void gx_draw_roundrect(jint pixel, const jshort *clip,
			       const gxj_screen_buffer *dst,
                               int dotted,
 ...
 * @param arcHeight The vertical diameter of the arc at the four corners
 */
void gx_fill_roundrect(jint pixel, const jshort *clip,
			      const gxj_screen_buffer *dst,
                              int dotted,
                              int x, int y, int width, int height,
                              int arcWidth, int arcHeight);
 ...
 *                 <tt>startAngle</tt>
 */
void gx_draw_arc(jint pixel, const jshort *clip,
			const gxj_screen_buffer *dst,
                        int dotted, int x, int y, int width, int height,
 ...
 *                 <tt>startAngle</tt>
 */
void gx_fill_arc(jint pixel, const jshort *clip,
			const gxj_screen_buffer *dst,
                        int dotted, int x, int y, int width, int height,
                        int startAngle, int arcAngle);
 ...
 */
void gx_fill_triangle(jint pixel, const jshort *clip,
 ...
 */
void gx_draw_chars(jint pixel, const jshort *clip,
			  const gxj_screen_buffer *dst,
                          int dotted,
 ...
 *        image to be drawn
 */
void gx_copy_area(const jshort *clip, const gxj_screen_buffer *dst,
 ...
 *        be ignored
 */
void gx_draw_rgb(const jshort *clip,
			const gxj_screen_buffer *dst, jint *rgbData,
