...
public class WindowingModuleFactoryImpl extends JUMPWindowingModuleFactory {

    private WindowingModuleImpl moduleImpl = new WindowingModuleImpl();
    ...
    public JUMPWindowingModule
    getModule(String policy) {
        return getModule();
    }
