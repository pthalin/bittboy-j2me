...
public class VirtualKeyboard {
	...
	private final static int WIDTH_IN_TILES=12, HEIGHT_IN_TILES=5;
...
//		case KEY_PAGE_DOWN_LARGE: inputCharacter=KEY_PAGE_DOWN; break;
	...
	private final static int KEY_MAP_QWERTY_LOWER[][]={
		{ KEY_ABC, 0, 0 }, { '1', 16, 0 }, { '2', 32, 0 }, { '3', 48, 0 }, { '4', 64, 0 }, { '5', 80, 0 }, { '6', 96, 0 }, { '7', 112, 0 }, { '8', 128, 0 }, { '9', 144, 0 }, { '0', 160, 0}, { KEY_TAB, 176, 0},
		{ KEY_ACCENTS, 0, 16 }, { 'q', 16, 16 }, { 'w', 32, 16 }, { 'e', 48, 16 }, { 'r', 64, 16 }, { 't', 80, 16 }, { 'y', 96, 16 }, { 'u', 112, 16 }, { 'i', 128, 16 }, { 'o', 144, 16 }, { 'p', 160, 16 }, { KEY_LEFT, 176, 16 },
		{ KEY_SYMBOLS, 0, 32 }, { 'a', 16, 32 }, { 's', 32, 32 }, { 'd', 48, 32 }, { 'f', 64, 32 }, { 'g', 80, 32 }, { 'h', 96, 32 }, { 'j', 112, 32 }, { 'k', 128, 32 }, { 'l', 144, 32 }, { '\'', 160, 32 }, { KEY_RIGHT, 176, 32 },
		{ KEY_CAPSLOCK, 0, 48 }, { 'z', 16, 48 }, { 'x', 32, 48 }, { 'c', 48, 48 }, { 'v', 64, 48 }, { 'b', 80, 48 }, { 'n', 96, 48 }, { 'm', 112, 48 }, { '(', 128, 48 }, { ')', 144, 48 }, { KEY_CANCEL, 160, 48 }, { KEY_UP, 176, 48 },
		{ KEY_SHIFT, 0, 64 }, { KEY_BACKSPACE, 16, 64 }, { ' ', 32, 64 }, { ',', 48, 64 }, { ':', 64, 64 }, { ';', 80, 64 }, { '.', 96, 64 }, { '!', 112, 64 }, { '?', 128, 64 }, { '-', 144, 64 }, { KEY_ENTER, 160, 64 }, { KEY_DOWN, 176, 64 }
	};
	...
	private final static int KEY_MAP_AZERTY_LOWER[][]={
		{ KEY_ABC, 0, 0 }, { '1', 16, 0 }, { '2', 32, 0 }, { '3', 48, 0 }, { '4', 64, 0 }, { '5', 80, 0 }, { '6', 96, 0 }, { '7', 112, 0 }, { '8', 128, 0 }, { '9', 144, 0 }, { '0', 160, 0}, { KEY_TAB, 176, 0},
		{ KEY_ACCENTS, 0, 16 }, { 'a', 16, 16 }, { 'z', 32, 16 }, { 'e', 48, 16 }, { 'r', 64, 16 }, { 't', 80, 16 }, { 'y', 96, 16 }, { 'u', 112, 16 }, { 'i', 128, 16 }, { 'o', 144, 16 }, { 'p', 160, 16 }, { KEY_LEFT, 176, 16 },
		{ KEY_SYMBOLS, 0, 32 }, { 'q', 16, 32 }, { 's', 32, 32 }, { 'd', 48, 32 }, { 'f', 64, 32 }, { 'g', 80, 32 }, { 'h', 96, 32 }, { 'j', 112, 32 }, { 'k', 128, 32 }, { 'l', 144, 32 }, { 'm', 160, 32 }, { KEY_RIGHT, 176, 32 },
		{ KEY_CAPSLOCK, 0, 48 }, { 'w', 16, 48 }, { 'x', 32, 48 }, { 'c', 48, 48 }, { 'v', 64, 48 }, { 'b', 80, 48 }, { 'n', 96, 48 }, { '\'', 112, 48 }, { '(', 128, 48 }, { ')', 144, 48 }, { KEY_CANCEL, 160, 48 }, { KEY_UP, 176, 48 },
		{ KEY_SHIFT, 0, 64 }, { KEY_BACKSPACE, 16, 64 }, { ' ', 32, 64 }, { ',', 48, 64 }, { ':', 64, 64 }, { ';', 80, 64 }, { '.', 96, 64 }, { '!', 112, 64 }, { '?', 128, 64 }, { '-', 144, 64 }, { KEY_ENTER, 160, 64 }, { KEY_DOWN, 176, 64 } 
	};
	...
	private final static int KEY_MAP_ACCENTS_LOWER[][]={
		{ KEY_ABC, 0, 0 }, { '`', 16, 0 }, { 0xb4, 32, 0 }, { '^', 48, 0 }, { 0xa8, 64, 0 }, { '~', 80, 0 }, { 0xb0, 96, 0 }, { 0xaf, 112, 0 }, { 0xb8, 128, 0}, { 0xe0, 144, 0 }, { 0xe1, 160, 0 }, { KEY_TAB, 176, 0},
		{ KEY_ACCENTS, 0, 16 }, { 0xe2, 16, 16 }, { 0xe3, 32, 16 }, { 0xe4, 48, 16 }, { 0xe5, 64, 16 }, { 0xe6, 80, 16 }, { 0xe7, 96, 16 }, { 0xe8, 112, 16 }, { 0xe9, 128, 16 }, { 0xea, 144, 16 }, { 0xeb, 160, 16 }, { KEY_LEFT, 176, 16 },
		{ KEY_SYMBOLS, 0, 32 }, { 0xec, 16, 32 }, { 0xed, 32, 32 }, { 0xee, 48, 32 }, { 0xef, 64, 32 }, { 0xf0, 80, 32 }, { 0xf1, 96, 32 }, { 0xf2, 112, 32 }, { 0xf3, 128, 32 }, { 0xf4, 144, 32 }, { 0xf5, 160, 32 }, { KEY_RIGHT, 176, 32 },
		{ KEY_CAPSLOCK, 0, 48 }, { 0xf6, 16, 48 }, { 0xf8, 32, 48 }, { 0xf9, 48, 48 }, { 0xfa, 64, 48 }, { 0xfb, 80, 48 },  { 0xfc, 96, 48 }, { 0xfd, 112, 48 }, { 0xfe, 128, 48 }, { 0xff, 144, 48 }, { KEY_CANCEL, 160, 48 }, { KEY_UP, 176, 48 },
		{ KEY_SHIFT, 0, 64 }, { KEY_BACKSPACE, 16, 64 }, { ' ', 32, 64 }, { ',', 48, 64 }, { ':', 64, 64 }, { ';', 80, 64 }, { '.', 96, 64 }, { '!', 112, 64 }, { '?', 128, 64 }, { '-', 144, 64 }, { KEY_ENTER, 160, 64 }, { KEY_DOWN, 176, 64 } 
	};
	
	// Map for accentuated upper case characters.
	private final static int KEY_MAP_ACCENTS_UPPER[][]={
		{ KEY_ABC, 0, 0 }, { '`', 16, 0 }, { 0xb4, 32, 0 }, { '^', 48, 0 }, { 0xa8, 64, 0 }, { '~', 80, 0 }, { 0xb0, 96, 0 }, { 0xaf, 112, 0 }, { 0xb8, 128, 0}, { 0xc0, 144, 0 }, { 0xc1, 160, 0 }, { KEY_TAB, 176, 0},
		{ KEY_ACCENTS, 0, 16 }, { 0xc2, 16, 16 }, { 0xc3, 32, 16 }, { 0xc4, 48, 16 }, { 0xc5, 64, 16 }, { 0xc6, 80, 16 }, { 0xc7, 96, 16 }, { 0xc8, 112, 16 }, { 0xc9, 128, 16 }, { 0xca, 144, 16 }, { 0xcb, 160, 16 }, { KEY_LEFT, 176, 16 },
		{ KEY_SYMBOLS, 0, 32 }, { 0xcc, 16, 32 }, { 0xcd, 32, 32 }, { 0xce, 48, 32 }, { 0xcf, 64, 32 }, { 0xd0, 80, 32 }, { 0xd1, 96, 32 }, { 0xd2, 112, 32 }, { 0xd3, 128, 32 },{ 0xd4, 144, 32 }, { 0xd5, 160, 32 }, { KEY_RIGHT, 176, 32 },
		{ KEY_CAPSLOCK, 0, 48 }, { 0xd6, 16, 48 }, { 0xd8, 32, 48 }, { 0xd9, 48, 48 }, { 0xda, 64, 48 }, { 0xdb, 80, 48 },  { 0xdc, 96, 48 }, { 0xdd, 112, 48 }, { 0xde, 128, 48 }, { 0xdf, 144, 48 }, { KEY_CANCEL, 160, 48 }, { KEY_UP, 176, 48 },
		{ KEY_SHIFT, 0, 64 }, { KEY_BACKSPACE, 16, 64 }, { ' ', 32, 64 }, { ',', 48, 64 }, { ':', 64, 64 }, { ';', 80, 64 }, { '.', 96, 64 }, { '!', 112, 64 }, { '?', 128, 64 }, { '-', 144, 64 }, { KEY_ENTER, 160, 64 }, { KEY_DOWN, 176, 64 } 
	};
	
	// Map for symbol characters.
	private final static int KEY_MAP_SYMBOLS[][]={
		{ KEY_ABC, 0, 0 }, { '&', 16, 0 }, { '|', 32, 0 }, { '-', 48, 0 }, { '+', 64, 0 }, { '*', 80, 0 }, { '/', 96, 0 }, { '=', 112, 0 }, { '<', 128, 0 }, { '>', 144, 0 }, { '~', 160, 0}, { KEY_TAB, 176, 0},
		{ KEY_ACCENTS, 0, 16 }, { 0xac, 16, 16 }, { 0xa6, 32, 16 }, { '_', 48, 16 }, { 0xf7, 64, 16 }, { 0xd7, 80, 16 }, { '\\', 96, 16 }, { 0xb1, 112, 16 }, { 0xab, 128, 16 }, { 0xbb, 144, 16 }, { '"', 160, 16 }, { KEY_LEFT, 176, 16 },
		{ KEY_SYMBOLS, 0, 32 }, { 0xa4, 16, 32 }, { '$', 32, 32 }, { 0xa2, 48, 32 }, { 0xa3, 64, 32 }, { 0xa5, 80, 32 }, { 0x20ac, 96, 32 }, { 0xb7, 112, 32 }, { '{', 128, 32 }, { '}', 144, 32 }, { '\'', 160, 32 }, { KEY_RIGHT, 176, 32 },
		{ KEY_CAPSLOCK, 0, 48 }, { 0xa9, 16, 48 }, { 0xae, 32, 48 }, { 0xb5, 48, 48 }, { 0xb6, 64, 48 }, { 0xa7, 80, 48 }, { '?', 96, 48 }, { '!', 112, 48 },  { '[', 128, 48 }, { ']', 144, 48 }, { KEY_CANCEL, 160, 48 }, { KEY_UP, 176, 48 },
		{ KEY_SHIFT, 0, 64 }, { KEY_BACKSPACE, 16, 64 }, { ' ', 32, 64 }, { '#', 48, 64 }, { '@', 64, 64 }, { '%', 80, 64 }, { 0xbf, 96, 64 }, { 0xa1, 112, 64 }, { '(', 128, 64 }, { ')', 144, 64 }, { KEY_ENTER, 160, 64 }, { KEY_DOWN, 176, 64 } 
	};
	...
	private final static int KEY_IMAGE_TABLE[][]={
		...
		{ KEY_UP,               0,      256,    16, 16 },
		{ KEY_DOWN,             16,     256,    16, 16 },
		{ KEY_LEFT,             32,     256,    16, 16 },
		{ KEY_RIGHT,            48,     256,    16, 16 },
	...
	private final static int KEY_IMAGE[]={
		...
		0x00000000,0x00000000,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,
		0x00000180,0x00000000,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,
        0x01800180,0x00000000,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,
        0x03c00180,0x030000c0,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,
        0x07e00180,0x06000060,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,
        0x0db00180,0x0c000030,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,
        0x09900990,0x1ff81ff8,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,
        0x01800db0,0x1ff81ff8,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,
        0x018007e0,0x0c000030,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,
        0x018003c0,0x06000060,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,
        0x01800180,0x030000c0,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,
        0x01800000,0x00000000,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,
        0x00000000,0x00000000,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,
        0x00000000,0x00000000,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF,0xFFFFFFFF
	};
}
