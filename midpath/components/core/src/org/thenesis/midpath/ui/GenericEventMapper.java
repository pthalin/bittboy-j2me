...
public class GenericEventMapper implements EventMapper {
	...
	private static boolean E61_NUMERIC_KEY;
	...
	public static void updateKeyMap() {
		...
		E61_NUMERIC_KEY = Configuration.getPropertyDefault("org.thenesis.midpath.ui.keys.E61_NUMERIC_KEY", "no").equals("yes") ? true : false;
	}
