...
//struct IMG_ImageData {
//    int width; /**< width in pixel */
//    int height; /**< height in pixel */
//    unsigned short *pixelData; /**< pointer to array of pixel data */
//    unsigned char *alphaData; /**< pointer to array of alpha data */
//    unsigned short *nativePixelData;
//    unsigned char *nativeAlphaData;
//};
