...
CLDC_JAR=${DIST_HOME}/dist/btclasses.zip:${JAR_DIST_HOME}/cldc1.1.jar
...
build_java $OPENGL_API_ENABLED components/jsr239-opengl/core $OPENGLES_CORE_JAR \
  :$MIDPATH_JAR:$MICROBACKEND_JAR:$J2SE_JAR
...
build_native $FILE_NATIVE_ENABLED native/file "-f Makefile.host"

# Build native nio part
build_native $NIO_NATIVE_ENABLED native/nio "-f Makefile.host"
...
build_native $SDL_ENABLED external/sdljava-cldc/native "-f Makefile.host"
